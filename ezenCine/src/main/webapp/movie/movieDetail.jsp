...
<!-- 영화 좋아요. -->
                	<div id="likeimage" class="on">
                        ...
                        <input type="hidden" id="movie-like" value="1" />
                    </div>
<%		
	}else{
%>
					<div id="likeimage">
                        <span id="c-movieLike"><%=dt.getLike() %></span>
                        <input type="hidden" id="movie-like" value="0" />
                    </div>
<%
	}
%>	            
            ...
            <div id="k-review" class="k-content container">
                ...
                <div class="k-reviewtitle">
                    ...
                    <div class="k-reviewtitle_ul">
                        <span class="c-review-tab"><a href="javascript:void(0)" class="k-score_1 active" id="k-score_1">최신순</a></span>
                        <span class="c-review-tab"><a href="javascript:void(0)" class="k-score_2" id="k-score_2">추천순</a></span>
                    </div>
                </div>
                <!-- 최신순 -->
...
%>
	                                        ...
	                                        <span class="k-review-starsnum"><%=(int) ss.getRating() %></span>
<%
...
%>	                                       
	                                    ...
	                                    <div class="c-review-bottom-content">
		                                    ...
		                                    <div class="c-mvrate">
						                        ...
						                        <span class="c-rating-number"><%=ss.getRating() %></span>
						                    </div>
...
<%
		...
		if(likeCnt == 0){
%>
												<span class="k-like2 c-current-like">
													<input type="hidden" class="review-like" value="0" />
												</span>
<%			
		}else{
%>
												<span class="k-like2 c-current-like on" >
													<input type="hidden" class="review-like" value="1" />
...
%>
					<div class="c-list-btn">
	                    <a href="javascript:cReviewMore(0);" class="k-list_btn">더보기 &nbsp; <span>></span></a>
	                    <a href="javascript:cReviewMore(1);" class="k-list_btn">더보기 &nbsp; <span>></span></a>
	                </div>	
<%			
		}else{
	%>
					<div class="c-list-btn">
	                    <a href="javascript:cReviewMore(0);" class="k-list_btn c-review-active">더보기 &nbsp; <span>></span></a>
	                    <a href="javascript:cReviewMore(1);" class="k-list_btn">더보기 &nbsp; <span>></span></a>
	                </div>
	<%		
		}
...
<script>
	window.onload = function(){
		btn = document.getElementsByClassName("k-list_btn");
		len = document.getElementsByClassName("c-currentlist").length;
		if(len <= 5){
