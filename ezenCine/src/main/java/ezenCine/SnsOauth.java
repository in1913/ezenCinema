...
public class SnsOauth {
	public static String getKakaoAccessToken (String code) {
        ...
        try {
            ...
            sb.append("&redirect_uri=http://localhost:8080/ezenCine/KakaoOauth"); // TODO 인가코드 받은 redirect_uri 입력
            sb.append("&code=" + code);
	...
	public static String getNaverAccessToken(String code, String state) {
		...
		try {
			redirectURI = URLEncoder.encode("http://localhost:8080/ezenCine/NaverOauth", "UTF-8");
